...
**Build sample: TYPE_OF_CAD=[CAD_LBT|CAD_ONLY|CAD_RX]**
```
rm -Rf build/ ; cmake -L -S examples  -B build -DCMAKE_BUILD_TYPE=MinSizeRel -DBOARD=NUCLEO_L476 -DRAC_RADIO=lr2021 -DTYPE_OF_CAD=CAD_LBT -G Ninja; cmake --build build --target cad
```
