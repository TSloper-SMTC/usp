...
**Build sample:**
```bash
rm -Rf build/ ; cmake -L -S examples  -B build -DCMAKE_BUILD_TYPE=MinSizeRel -DBOARD=NUCLEO_L476 -DRAC_RADIO=lr1110 -DAPP=WIFI_REGION_DETECTION -G Ninja; cmake --build build --target wifi_region_detection
```
