...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] =
        ...
        { .pin = BSP_IO_PORT_00_PIN_00, .pin_cfg = ((uint32_t) IOPORT_CFG_ANALOG_ENABLE) },
          ...
          { .pin = BSP_IO_PORT_00_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_ANALOG_ENABLE) },
          ...
          { .pin = BSP_IO_PORT_01_PIN_13, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },

          { .pin = BSP_IO_PORT_01_PIN_14, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          ...
          { .pin = BSP_IO_PORT_02_PIN_05, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          ...
          { .pin = BSP_IO_PORT_02_PIN_12, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },

          { .pin = BSP_IO_PORT_02_PIN_13, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          ...
          { .pin = BSP_IO_PORT_05_PIN_00, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
                  | (uint32_t) IOPORT_PERIPHERAL_SAU2_OUT) },
          ...
          { .pin = BSP_IO_PORT_05_PIN_02, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
                  | (uint32_t) IOPORT_PERIPHERAL_SAU2) },
