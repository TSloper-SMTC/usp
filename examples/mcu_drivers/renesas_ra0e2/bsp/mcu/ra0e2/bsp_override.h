...
/*******************************************************************************************************************//**
 * @addtogroup BSP_MCU_RA0E2
 * @{
 **********************************************************************************************************************/

/** @} (end addtogroup BSP_MCU_RA0E2) */
...
typedef enum e_ioport_peripheral
{
    ...
    IOPORT_PERIPHERAL_UARTA3     = (0x03UL << IOPORT_PRV_PSEL_OFFSET),
    ...
    IOPORT_PERIPHERAL_UARTA3_OUT = ((0x03UL << IOPORT_PRV_PSEL_OFFSET) | IOPORT_PERIPHERAL_PIN_OUT),
    ...
    IOPORT_PERIPHERAL_IICA2      = (0x02UL << IOPORT_PRV_PSEL_OFFSET),
    ...
    IOPORT_PERIPHERAL_BUZ4       = ((0x04UL << IOPORT_PRV_PSEL_OFFSET) | IOPORT_PERIPHERAL_PIN_OUT),
...
typedef enum e_adc_channel
{
    ...
    ADC_CHANNEL_11                 = 11,  ///< Channel 11 for select mode
    ADC_CHANNEL_12                 = 12,  ///< Channel 12 for select mode
