...
#define BSP_FEATURE_ADC_D_CHANNELS_MASK                           (0x00601FFFUL)    // Mask of available channels.
#define BSP_FEATURE_ADC_D_SCAN_MODE_CHANNELS_MASK                 (0x03FFUL)        // Mask of channels available in scan mode.
...
#define BSP_FEATURE_GPT_AD_DIRECT_START_CHANNEL_MASK              (0x00UL)          // Feature not available on this device.
...
#define BSP_FEATURE_ICU_SBYEDCR_MASK                              (0x00003F838C1407FFULL)   // A mask of valid bits for [SBYEDCR1:SBYEDCR0].
